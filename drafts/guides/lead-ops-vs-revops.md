...
If you want the boundary drawn against your own instance rather than in the abstract, a [lead operations audit](/audit/?utm=guide-revops) returns the accountability table and the shared object contract filled in with the names and rules currently running in your systems, plus the list of decisions that turned out to have no owner at all.
