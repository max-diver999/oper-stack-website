 ...
 */
import { checkVisibility, VISIBILITY_MESSAGES as MESSAGES } from '@operstack/audit';
...
const cases = [
  ...
  [R.answerFirstMissing(0, 1, '/'), 'Единственная проверенная страница не начинается с абзаца-ответа (20-90 слов с цифрой сразу после H1). Именно этот абзац попадает в цитату. Чинить здесь: /.'],
  [R.answerFirstMissing(2, 3, '/terms'), 'Из 3 проверенных страниц с абзаца-ответа (20-90 слов с цифрой сразу после H1) начинаются 2. Именно этот абзац попадает в цитату. Чинить здесь: /terms.'],
  [R.answerFirstMissing(1, 2, '/guides'), 'Из 2 проверенных страниц с абзаца-ответа (20-90 слов с цифрой сразу после H1) начинается одна. Именно этот абзац попадает в цитату. Чинить здесь: /guides.'],
