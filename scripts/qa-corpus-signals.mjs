...
const fq = spawnSync('node', ['scripts/fix-batch-queue.mjs', '--json', '--not-ready', '--limit', '15'], {
  cwd: ROOT,
  encoding: 'utf8',
...
// fix-queue-blocker items are P1 (fix-batch); gate only fails on parse errors here.
