import {
  detectExternalAiSource as detectReferenceExternalAiSource,
  type ExternalAiSource as ReferenceExternalAiSource,
} from './external-ai-sources';

export type ExternalAiSource = ReferenceExternalAiSource | '';
...
export function detectExternalAiSource(referrer: string): ExternalAiSource {
  return detectReferenceExternalAiSource(referrer) ?? '';
}
