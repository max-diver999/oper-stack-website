...
'rival-watch': {
  ...
  'seo-audit': {
    plain:
      'You name your website address, we read a hundred pages of it and send back a report within minutes, in plain words: what stops your site from being found in Google and quoted by AI assistants, what to fix first, what each fix costs, and a plan. With it come three files you only have to put on the site, and five rivals measured beside you. A few days later a person goes over the same report by hand and writes separately. Everything is written down, nothing depends on a call. You can hand the plan to any developer or ask us to do the work.',
    who: [
