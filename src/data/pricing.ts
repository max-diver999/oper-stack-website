...
export const PRICING_FAQ = [
  {
    ...
    answer:
      'Two things sold from one place. Products you buy off the shelf for a content site that has to rank and be quoted by AI assistants: a weekly subscription, OperStack Watch, at $35 a month, and the tools on the products page. And setup work for businesses that live on inbound leads: routing, CRM wiring, AI qualification and reporting, connected by one Lead Hub and quoted per project.',
  },
  {
