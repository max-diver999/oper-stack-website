...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    faq: [{ question: 'When does it ship?', answer: 'The starter, the gates and the plugin are live now. Site Kit follows once the checkout is open; the launch list is told first.' }, { question: 'Which model does the generator use?', answer: 'Claude or an OpenAI model, through your own API key: pick the provider with one flag. The kit ships prompts, templates and the gates loop, not tokens. A page costs a few cents of tokens and usually passes the gates in the first round.' }, { question: 'Is there a refund?', answer: 'Fourteen days, no questions, if the kit did not do what this page says.' }],
