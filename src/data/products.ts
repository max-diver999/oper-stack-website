...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    label: 'Paid, per site',
    name: 'Site fix list',
    title: 'What to Fix on Your Site, Written Out Task by Task, 9 USD',
    description: 'Every problem found on your site, rewritten as a task you can hand to anyone: whoever built your site, or an assistant like ChatGPT, Claude or Cursor. Each task says what your site does now, what to change, and how to check it is done. The full measurement comes with it. 9 USD, one site, by email.',
    ...
    order: 5,
    get: [
      'A list of tasks, one for every problem found, written in plain words',
      'Each task says three things: what your site does now, what to change, and how to check it is done',
      'Ready to hand over as it is: give one to whoever looks after your site, or paste it into ChatGPT, Claude or Cursor',
      'A rule inside every task that stops an assistant inventing facts about your business',
      'The measurement behind the tasks: six area scores with the count of checks behind each one, and "not measured" wherever something was not tested',
      ...
      'The three things to fix first, in the order that moves the score most',
    ],
    how: [
  ...
  },
  {
    slug: 'rival-watch',
    label: 'Paid, per site',
    name: 'You and three rivals, side by side',
    title: 'Compare Your Site With Three Rivals, 29 USD',
    description: 'The full measurement of your site and of up to three rivals in one table, so you can see who gets named instead of you and exactly where they are ahead. 29 USD, one site, one comparison, no subscription.',
    answer: 'The rival comparison runs the automatic site report on your site and on up to three competitors at once and puts the six area scores and the checks that matter most in one table. You see who an answer engine can quote instead of you and exactly where they are ahead of you. You pay once, the comparison arrives by email, and there is nothing to cancel.',
    price: '29 USD',
    priceNote: 'One site and up to three rivals, one comparison by email. You pay once: there is no subscription to cancel',
    status: 'available',
    ...
    get: [
      ...
      'Who gets named instead of you, and which checks put them ahead',
      'A plain verdict rather than a dashboard to log into',
    ],
    how: [
      { step: 'Pay', text: 'Card on Whop. You get an email with one link straight away.' },
      ...
      { step: 'Read it', text: 'The comparison arrives by email, usually within the hour. One file, nothing to log into.' },
    ],
    needs: [
    ...
    notFor: [
      'Watching week by week: everything here is measured once, on the day you buy',
      'Anyone who wants a person to read the findings: that is the 149 USD audit',
      'Sites behind a login, and sites that block automated readers',
    ],
    faq: [
      { question: 'Is this a subscription?', answer: 'No. You pay once, the comparison arrives and that is the end of it. There is nothing to cancel and no card left on file with us.' },
      ...
      { question: 'Can I have it measured again later?', answer: 'Yes, by buying it again once you have actually changed something. We do not re-read the site on a schedule: measuring an unchanged site every week would just send you the same table.' },
      { question: 'What happens after I get it?', answer: 'Nothing happens by itself. It is one comparison: no entry that expires, no emails that follow, nothing left running.' },
    ],
    relatedGuides: [{ title: 'AEO and GEO for inbound marketing', href: '/guides/aeo-geo-inbound-marketing/' }, { title: 'Inbound lead audit', href: '/guides/inbound-lead-audit/' }],
  },
  {
