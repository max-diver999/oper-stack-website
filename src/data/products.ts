...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    price: '79 USD',
    priceNote: 'One licence per owner, unlimited own sites; any updates released within twelve months are included',
    status: 'soon',
    cta: { text: 'Join the launch list', href: '/audit/?utm=products-site-kit' },
    og: '/og/og-default.png',
    order: 4,
    get: ['Everything in the free starter', 'The page generator: topic list to briefs to MDX, with the gates in the loop until each page passes', 'Niche discovery: seed terms to autocomplete and SERP shapes to a page plan with volumes where a source exists', 'Indexing runbooks: Search Console, Bing, IndexNow, the Google Indexing API on a per-site project, llms.txt', 'Quick start written for people who have never used a terminal, the licence agreement, your licence key, and email support for the licence term'],
    how: [{ step: 'Buy', text: 'One payment through the checkout; the licence key and the download link arrive by email.' }, { step: 'Activate', text: 'Paste one command with your key into the terminal; the quick start shows exactly where. The generator and the discovery module unlock.' }, { step: 'Launch', text: 'Discover the niche, generate the first thirty pages, verify with the gates, deploy, submit.' }],
