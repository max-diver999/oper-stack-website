...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    needs: [
      ...
      { item: 'A domain name, only when you want your own address', cost: 'Paid, about $10 to $15 a year', why: 'Bought from any registrar. Until then the free hosting address works.' },
    ],
  ...
  },
  {
    ...
    notFor: [
      ...
      'Anyone who wants a person to read the findings: that is the $149 audit',
    ],
    faq: [
  ...
  },
  {
    ...
    description: 'Not one fix but all of them. Not five pages but the whole site. Each written so you can hand it over without explaining: what your site does now, what to change, how to check it worked. $9, one site, by email.',
    ...
    // Как только ссылка на оплату появится в checkout.ts, кнопка сама станет «Buy for $9».
    cta: { text: 'Buy for $9', href: 'https://whop.com/oper-stack/automatic-site-report', external: true },
    ...
    notFor: [
      'Anyone who wants a person to read the findings and explain what they mean for their business: that is the $149 audit',
      'Anyone who wants the work done for them: that is Fix at $249',
      'Sites behind a login, and sites that block automated readers',
    ],
    faq: [
      ...
      { question: 'Does a person read my report?', answer: 'No. Every number is measured and the wording is drafted from those measurements. If you want a person to read each finding and write what it means for your business, that is the $149 audit.' },
  ...
  },
  {
    ...
    status: 'available',
    cta: { text: 'Buy for $25', href: 'https://whop.com/oper-stack/invisible-to-chatgpt', external: true },
    og: '/og/og-course.png',
    order: 6,
    get: [
    ...
    needs: [
      { item: 'An email address on your own domain', cost: 'About $6 a month', why: 'Outreach from a free mailbox is filtered before a person sees it. If you already have one, you need nothing else.' },
  ...
  },
  {
    ...
    description: 'Everything in the $9 list, plus the same measurement on three rivals beside yours. You see exactly where they are ahead, and it is a measurement, not an opinion. $29, one site, no subscription.',
    answer: 'The rival comparison gives you every fix for your own site, as in the $9 list, and beside it the same measurement on up to three competitors you name, in one table. You see where you lead, where you trail, and which of the gap your own fix list closes. Then once a week for four weeks a snapshot arrives: what your fixes moved and how the gap changed. You pay once and there is nothing to cancel.',
    price: '$29',
    priceNote: 'One site and up to three rivals, plus four weekly snapshots. You pay once: there is no subscription to cancel',
    status: 'available',
    cta: { text: 'Buy for $29', href: 'https://whop.com/oper-stack/you-and-three-rivals-watched-for-a-month', external: true },
    og: '/og/og-rival-watch.png',
    order: 7,
    get: [
      'Every fix for your own site, as in the $9 list',
  ...
  },
  {
    ...
    status: 'available',
    cta: { text: 'Buy for $69', href: 'https://whop.com/oper-stack/pain-to-seo', external: true },
  ...
  },
  {
    ...
    description: 'The starter plus the page generator, the niche discovery module, a WordPress importer, indexing runbooks and support: everything one person needs to launch a content site that passes the gates, or to move an old one onto them. $79, one licence per owner, unlimited sites, updates for a year.',
    ...
    status: 'available',
    cta: { text: 'Buy for $79', href: 'https://whop.com/oper-stack/operstack-site-kit', external: true },
    ...
    needs: [
      ...
      { item: 'A domain name, only when you want your own address', cost: 'Paid, about $10 to $15 a year', why: 'Bought from any registrar.' },
    ],
  ...
  },
  {
    ...
    description: 'Run the audit on any number of client sites and hand each client a PDF carrying your logo, your colour and your name. $39 a month, cancel any time, no per-report fee.',
    ...
    status: 'available',
    cta: { text: 'Start for $39 a month', href: 'https://whop.com/oper-stack/agency-plan-reports-under-your-own-brand', external: true },
    og: '/og/og-agency.png',
    order: 10,
    get: [
    ...
    notFor: [
      ...
      'One site only: if you are auditing your own site once, the $9 report is the honest purchase',
    ...
    faq: [
      ...
      { question: 'What do I charge my clients?', answer: 'That is your call. What we can tell you is what the same report costs from us: $9 automatic, $149 when a person writes the analysis. Agencies generally sit between those and above.' },
    ],
    relatedGuides: [],
  },
  {
    ...
    description: 'The flagship of OperStack and the reason the company exists at all. An audit of your site with the edits already made for you: a hundred pages, five rivals beside it, and three files you only have to put on the site. The report arrives within minutes; a person then goes over it by hand. $149 for the first ten audits, then $249.',
    ...
    price: '$149',
    priceNote: 'The price of the first ten audits, then $249. With read-only access to your own free Search Console and Bing Webmaster it is $199 and adds your real queries and positions. The report arrives within minutes, the letter from a person within three working days',
    status: 'available',
    cta: { text: 'Buy the audit for $149', href: 'https://whop.com/oper-stack/seo-aeo-and-geo-audit', external: true },
    og: '/og/og-audit.png',
    order: 11,
    get: [
    ...
    how: [
      { step: 'Name the site', text: 'Paying brings an email with a link to a form: your site address and up to five rivals. Leave the rival fields empty if you have none in mind. For the $199 tier, read-only access to your Search Console and Bing.' },
    ...
    needs: [
      { item: 'Your site address', cost: 'Free', why: 'That is the whole requirement for the $149 report. Every score in it is computed from what anyone can read on your site for nothing.' },
      { item: 'Google Search Console, for the $199 tier', cost: 'Free, but you need your own free Google account', why: 'Read-only access to your own property. It adds your real queries, impressions and positions to the report. Setting it up takes about ten minutes and is worth having whether you buy an audit or not.' },
      { item: 'Bing Webmaster Tools, for the $199 tier', cost: 'Free, but you need your own free Microsoft account', why: 'Bing shows the conversational questions AI assistants retrieve your site for, which Google does not.' },
    ...
    faq: [
      ...
      { question: 'What do you need from us?', answer: 'The URL. For the $199 tier, read-only access to Search Console and Bing Webmaster, both free and both yours.' },
      { question: 'What happens after the audit?', answer: 'Two packages. Fix at $249 closes the checks that do not need your subject knowledge, against a list we agree before you pay. Foundation starts at $500 and adds the writing: the opening paragraphs, the named sources and the missing pages, quoted after the audit because the price depends on how many pages earn impressions.' },
    ],
  ...
  },
  {
    ...
    price: '$249',
    priceNote: '$249 covers a site of up to about fifty pages. Larger corpora are quoted on the list, because the gates run over every page rather than a sample. The list is agreed in writing before payment, and anything on it we do not close comes back as a refund of its share',
    status: 'available',
  ...
  },
  {
    ...
    description: 'Everything in Fix, plus the three things a machine cannot do for you: an opening paragraph that can be quoted, a named source next to every figure, and the pages your market asks for that do not exist yet. From $500, quoted after the audit.',
    ...
    needs: [
      { item: 'The audit', cost: '$149 for the first ten', why: 'Foundation is quoted from it. Without the audit we would be guessing at the page count and the state of the writing.' },
    ...
    faq: [
      ...
      { question: 'Can I do this myself?', answer: 'Yes, and for many people that is the right answer. Site Kit is the same pipeline packaged for one person at $79, and the free gates check the result. Foundation is for people who would rather buy the hours than spend them.' },
      { question: 'What is the minimum?', answer: '$500. Below that the quote is not worth writing and Fix plus Site Kit gets you further for less.' },
    ],
    relatedGuides: [{ title: 'Programmatic SEO for lead generation', href: '/guides/programmatic-seo-lead-gen/' }, { title: 'AEO and GEO for inbound marketing', href: '/guides/aeo-geo-inbound-marketing/' }],
