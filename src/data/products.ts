...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    faq: [
      ...
      { question: 'How is this different from the free check?', answer: 'The free check opens one page and gives you a score. This opens up to twenty pages, runs every check behind the paid audit, and turns each failure into a task you can hand over. The free check tells you there is a problem; this tells you what to say to get it fixed.' },
