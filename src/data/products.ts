...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    slug: 'seo-audit',
    label: 'Paid, per site',
    name: 'Audit: why the site brings no leads, and what to fix first',
    title: 'Audit: Why the Site Brings No Leads',
    description: 'Not "can AI read you" but the whole path from a search to an enquiry. Six areas, a demand map, a week-by-week plan, and a person who writes what it all means for your business. 149 USD for the first ten audits, then 249. Usually one to three working days, five at most.',
    ...
    order: 11,
    get: [
      'Six areas instead of five: technical, content, answer engines, links and trust, the path to an enquiry. Every check with its own finding',
      ...
      'A re-check after 90 days by the same code: what moved',
      ...
      'How much of your text is invisible without JavaScript, measured in a real browser, because the fetchers that quote you do not run scripts',
      'A person reads every finding and writes what it means for your business. Usually one to three working days, never later than five',
    ],
    how: [{ step: 'Order', text: 'Send the site and how to reach you. We confirm scope and the tier within 24 hours.' }, { step: 'Collect and read', text: 'Public signals are collected automatically; the analyst reads the content and the pages that outrank it.' }, { step: 'Deliver, then re-check', text: 'The PDF report by email, usually within one to three working days and never later than five. The two packages are quoted in the same letter. Ninety days later the same code measures the site again and you get what moved.' }],
    needs: [
