...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    description: 'We close the mechanical findings on your site: robots, sitemap, llms.txt, schema, headings, contact path, redirects, caching, plus the fifteen gates over every page. The list is agreed before you pay, and anything we do not close comes back as a refund of its share.',
    answer: 'Fix closes the findings that do not need to know anything about your business: crawler access, the sitemap and its hygiene, llms.txt, structured data, headings and descriptions, the contact path and the form, redirects, caching headers, broken internal links and duplicate images. Thirty-five of the forty checks in the audit fall in this group. We name the exact list for your site before you pay, and we re-check the site thirty days later and email you what moved.',
    price: '249 USD',
    ...
    order: 6,
    get: [
      'The checks from your audit that do not need your subject knowledge, closed. Thirty-five of the forty fall in that group on a typical site',
      'The fifteen quality gates run over every page of your corpus, not a sample: cut titles, copied paragraphs, hollow sections, dead links, stale llms.txt, figures with no source',
    ...
    needs: [
      ...
      { item: 'Text that lives in files, for the gates', cost: 'Free', why: 'The fifteen gates read Markdown or MDX files. On WordPress, Tilda and similar the gates cannot run, so they never enter your list and you are not charged for them. Everything else on this page works on any platform.' },
  ...
  },
  {
    ...
    answer: 'Foundation is Fix plus the writing. Three of the forty checks need to know your business: whether a page opens with an answer carrying a figure, whether that figure names its source, and whether the page has enough substance to be cited at all. We rewrite the openings on the pages that already earn impressions, add sources to the figures, and build the pages your market asks for and you do not have. The price depends on how many pages earn impressions and how much rewriting they need, so it is quoted after the audit rather than guessed here.',
    price: 'from 500 USD',
    ...
    how: [
      ...
      { step: 'Write, check, ship', text: 'Every page goes through the fifteen gates before it goes live. Timing is in the quote and depends on the page count.' },
    ],
    needs: [
