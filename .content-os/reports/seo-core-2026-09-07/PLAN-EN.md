...
| EN-3, остаток ядра A | 6 | не начата |
| EN-4, перелинковка | 0 | частично сделана попутно |

Итого план вырос с 21 страницы до 31 после ревью волны 1, где нашлись две мои недоработки.
...
| Действие | Страниц |
|---|---:|
| создать | **31** (19 сделано, 12 осталось) |
